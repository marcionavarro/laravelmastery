...
<head>
    ...
    <link rel="canonical" href="http://127.0.0.1:8989">
    ...
    <ul class="navbar-nav flex-row mr-5">
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="{{ route('admin.profile.edit') }}">Meu Perfil</a>
                <a class="dropdown-item" href="#"
                   onclick="event.preventDefault(); document.getElementById('logout').submit()">Sair</a>
